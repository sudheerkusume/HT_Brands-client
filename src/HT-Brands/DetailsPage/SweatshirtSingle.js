...
const SweatShirtSingle = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://htbrands-server.onrender.com/SweatShirt/${id}`)
      .then((res) => {
        setProduct(res.data);
    ...
    <div className="container py-5">
      <div className="row gx-5 gy-4">
        ...
        <div className="col-lg-6">
          ...
          <Link to="/SweatShirt" className="text-decoration-none text-secondary">
...
export default SweatShirtSingle;
