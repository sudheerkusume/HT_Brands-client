...
//   useEffect(() => {
//     axios.get("http://localhost:5000/Cargo")
//       .then((res) => {
...
//     const price = parseInt(product.Offer.replace(/\D/g, ''));
//     return (
...
//         <h4 className="text-dark">All Neck T-Shirts</h4>
...
//                             {value} <span className=""style={{fontSize:"13px", fontWeight:290, padding:"6px"}}>({getFilteredCount(filterType, value)})</span>
//                           </label>
//                         </div>
//                       ))
//                     ) : (
...
//                 <div className="col-6 col-md-4 col-lg-4 mb-4" key={product._id}>
//   <Link to={`/Bottomwear/${product._id}`} className="text-decoration-none text-dark">
...
const BottomwearPage = () => {
  ...
  useEffect(() => {
    axios.get("https://htbrands-server.onrender.com/Cargo")
      .then((res) => {
        setProducts(res.data);
