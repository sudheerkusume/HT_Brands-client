...
//         <h4 className="text-dark">All Shirts</h4>
...
//           <div className="p-4 border rounded shadow-sm" style={{ position: "sticky", top: "100px" }}>
//             {Object.entries(filters).map(([filterType, values]) => (
//               <div key={filterType} className="mb-3">
//                 <div className="d-flex justify-content-between align-items-center" style={{ cursor: "pointer" }} onClick={() => toggleSection(filterType)}>
//                   <h6 className="text-capitalize mb-0">{filterType.replace(/_/g, ' ')}</h6>
//                   <span style={{
...
//                       />
//                       <label htmlFor={`${filterType}-${idx}`} className="form-check-label">
//                         {value}
//                       </label>
//                     </div>
//                   ))}
...
//                 <Link to={`/shirts/${product._id}`} className="text-decoration-none text-dark">
//                   <div className="card h-100 shadow-sm">
//                     <div className="card-img-container position-relative">
//                       <img
//                         src={product.Album?.[0] || 'https://via.placeholder.com/300'}
...
//                           src={product.Album[1]}
//                           alt="Hover"
//                           className="hover-img position-absolute"
...
//                       <h6 className="mb-1" style={{ fontSize: '13px', fontWeight: '500' }}>{product.Title}</h6>
//                       <div className="mb-1 text-danger">{product.Offer}</div>
...
const ShirtsPage = () => {
  ...
  useEffect(() => {
    axios.get("https://htbrands-server.onrender.com/shirts")
      .then((res) => {
        setProducts(res.data);
